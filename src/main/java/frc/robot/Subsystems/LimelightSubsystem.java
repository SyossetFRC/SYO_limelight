...
public class LimelightSubsystem extends SubsystemBase {
    ...
    private double horizontalTargetAngle;//horizontal angle crosshair to object (april tag) detected
    private double verticalTargetAngle;//vertical angle crosshair to object(april tag) detected
