...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    Button m_limelightAlignment = new Button(() -> m_operatorController.getRawButton(5));
    m_limelightAlignment.whileHeld(new LimelightAlignment(m_drivetrainSubsystem, m_limelightSubsystem));
    m_limelightAlignment.whenReleased(() -> m_drivetrainSubsystem.drive(new ChassisSpeeds(0, 0, 0)));
  }
